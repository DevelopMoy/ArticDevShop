<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div id="carritoBtn">
            ...
            <?php if(isset($_SESSION["userNombre"])&&!empty($_SESSION["userNombre"])){echo '<a href="/appweb/mod/carrito.php" ><img src="/appweb/images/carticon.svg"></a>';}else{echo '<a href="/appweb/mod/loginView.php" ><img src="/appweb/images/carticon.svg"></a>';} ?>
